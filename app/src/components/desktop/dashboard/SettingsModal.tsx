                                    ...
                                    >
                                        <div className="flex flex-col items-center py-6 space-y-5">
                                            ...
                                            <div className="text-center space-y-3">
                                                <div>
                                                    <p className="text-sm font-semibold text-telegram-text">Shohan</p>
                                                </div>

                                                {/* Website Link */}
                                                <button
                                                    onClick={(e) => { e.preventDefault(); open('https://github.com/shohan-001'); }}
                                                ...
                                                {/* GitHub Link */}
                                                <button
                                                    onClick={(e) => { e.preventDefault(); open('https://github.com/shohan-001/telegram-cloud-drive'); }}
                                                    className="flex items-center justify-center gap-1.5 text-xs text-telegram-primary hover:text-telegram-primary/80 transition-colors cursor-pointer"
                                                >
                                                    ...
                                                    github.com/shohan-001/telegram-cloud-drive
                                                </button>
                                            </div>
